...
def main():
	...
	print("\033[96;1m  [J] FOLLOW MY PAGE \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		print("\t\033[91;1m  SELECT AN OPTION BRO -_")
		log_sel()
	elif sel =="1" or sel =="01":
		token()
	elif sel =="2" or sel =="02":
		subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100074666619670"])
		main()
